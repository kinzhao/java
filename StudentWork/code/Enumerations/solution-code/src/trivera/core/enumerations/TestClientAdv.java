...
/**
 * TestClient for enumerations lab
 *
 * <p>
...
public class TestClientAdv {
    ...
    public static void main(String args[]){
        ...
        for(USState state: USState.values()){
           //Invoke getStateName() and getStateCapital() on each enum to display
           //The name and the capital of each state in the U.S.
           System.out.println(state.getStateName() + " - " + state.getStateCapital());
       }
    }
}
