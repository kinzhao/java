    ...
    public static void main(java.lang.String[] args) {
        ...
        while (true) {
            ...
            if (cmd.startsWith("1")) {
                ...
                // LAB HINT: Deal the five cards
            } else if (cmd.startsWith("2")){

                // LAB HINT: Get the list of the entire deck
            ...
            // LAB HINT: Iterate through the returned list, printing the cards
            //           in list order
            // LAB HINT: The toString method of Card is sufficient to print
            //           the cards correctly
