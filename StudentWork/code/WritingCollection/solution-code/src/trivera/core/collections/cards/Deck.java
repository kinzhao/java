 ...
 */
public class Deck extends AbstractList<Card> {
     ...
     *
     * This method uses the list's ability to sub-list to take the first N cards
     * from the top of the deck. The sub-list is sorted using the custom
  ...
  public List<Card> getCards(int count) {
        ...
        List<Card> cardHand = deck.subList(0, 5);
  ...
  public Card set(int index, Card element) {
      return this.deck.set(index,element);
  }
